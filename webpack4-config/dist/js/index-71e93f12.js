...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nconsole.log('this is m'); // webpackPrefetch待首屏核心代码加载完成后，自动加载m.js,\n// 防止按需加载(比如点击按钮加载) 时候，m.js文件太大，导致loading或者空白，\n// 所以需要在加载完首屏核心代码后，再去加载这个文件。\n\nPromise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./m.js */ \"./src/js/m.js\")).then(function (m) {\n  console.log('m is loaded');\n});\n/* harmony default export */ __webpack_exports__[\"default\"] = ('m.js');\n\n//# sourceURL=webpack:///./src/js/m.js?");

/***/ })

},[["./src/js/index.js","mainfest","es6-demand","vendors~index","index~main"]]]);